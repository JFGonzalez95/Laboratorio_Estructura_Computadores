...
main:
    ...
    sgt $t3,$t0,$t1 # Evalua si el numero1 > numero 2 --> {True: 1 , False:0}
    sgt $t4,$t0,$t2 # Evalua si el numero1 > numero 3 --> {True: 1 , False:0} 
    ...
    sgt $t5,$t1,$t0 # Evalua si el numero2 > numero 1 --> {True: 1 , False:0}
    sgt $t6,$t1,$t2 # Evalua si el numero2 > numero 3 --> {True: 1 , False:0} 
